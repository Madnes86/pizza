  ...
  <header class="header">
    ...
    <div class="search">
      ...
      <div class="search__cross" v-if="searchInput" @click="clearSearch">
        <span class="search__line search__line--first"></span>
        <span class="search__line search__line--second"></span>
      </div>
    </div>
    <div style="display: flex; gap: 10px;">
      ...
      <button class="header__button" id="button-basket">
        <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <path d="M4.77984 4.99984H16.3332L15.2132 10.5932C15.1522 10.9001 14.9852 11.1758 14.7415 11.372C14.4977 11.5683 14.1927 11.6725 13.8798 11.6665H6.83317C6.50763 11.6693 6.19232 11.5528 5.94671 11.3391C5.70109 11.1255 5.54215 10.8293 5.49984 10.5065L4.4865 2.8265C4.44448 2.50599 4.28745 2.21167 4.04464 1.99828C3.80182 1.7849 3.48976 1.66699 3.1665 1.66699H1.6665" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
        </svg>
        Корзина
      </button>
    </div>
